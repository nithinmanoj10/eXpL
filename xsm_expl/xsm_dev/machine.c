...
int machine_serve_instruction(char _output_ *buffer, unsigned long _output_ *read_bytes, int _input_ max)
{
...
void machine_get_mem_access(int *mem_low, int *mem_high)
{
...
int machine_translate_address(int address, int write)
{
   int ptbr;
