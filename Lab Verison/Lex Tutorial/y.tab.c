...
yyreduce:
  ...
  switch (yyn)
    {
  case 3:
#line 13 "yydesk_calc.y"
                                    {printf("= %d\n", yyvsp[-2])}
#line 1311 "y.tab.c"
    break;

  case 5:
#line 17 "yydesk_calc.y"
                                  {yyval = yyvsp[-2] + yyvsp[0];}
#line 1317 "y.tab.c"
    break;

  case 6:
#line 18 "yydesk_calc.y"
                                  {yyval = yyvsp[-2] - yyvsp[0];}
#line 1323 "y.tab.c"
    break;

  case 8:
#line 22 "yydesk_calc.y"
                                   {yyval = yyvsp[-2] * yyvsp[0];}
#line 1329 "y.tab.c"
    break;

  case 9:
#line 23 "yydesk_calc.y"
                                   {yyval = yyvsp[-2] / yyvsp[0];}
#line 1335 "y.tab.c"
    break;

  case 11:
#line 27 "yydesk_calc.y"
                            {yyval = yyvsp[0] >= 0 ? yyvsp[0] : -1 * yyvsp[0];}
#line 1341 "y.tab.c"
    break;
